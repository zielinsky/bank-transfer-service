...
@Singleton
public class TransfersByAccountIdHandler implements Handler {
    private final TransferService transferService;

    @Inject
    public TransfersByAccountIdHandler(TransferService transferService) {
    ...
    public void handle(Context ctx) {
        try {
            List<TransferDto> transferDtoList = transferService.getAllTransfersForAccount(
