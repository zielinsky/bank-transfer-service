...
@Singleton
public class IncomingTransfersHandler implements Handler {
    private final TransferService transferService;

    @Inject
    public IncomingTransfersHandler(TransferService transferService) {
    ...
    public void handle(Context ctx) {
        try {
            List<TransferDto> transferDtoList = transferService.getIncomingTransfers(
